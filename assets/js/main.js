    ...
    jQuery(document).ready(function(){
        ...
        */
        ...
        $('.ltn__shop-details-small-img').slick({
            ...
            arrows: true,
            focusOnSelect: true,
            prevArrow: '<a class="slick-prev"><i class="ri-arrow-left-s-line" alt="Arrow Icon"></i></a>',
            nextArrow: '<a class="slick-next"><i class="ri-arrow-right-s-line" alt="Arrow Icon"></i></a>',
            responsive: [
                {
                    breakpoint: 992,
                    settings: {
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("coming-soon").innerHTML = "New Product";
  }
}, 1000);
